...
/*!  
*  @file	core_configurator.h
*  @brief	
*  @author	
*  @sa		core_configurator.c 
*  @date	1 Mar 2012
*  @version	1.0
*/
...
extern ATL_Uint16 g_num_total_switches;
...
/* Function Macros                                                           */
/*****************************************************************************/
#define MAKE_WORD16(lsb, msb) (((ATL_Uint16)(msb) << 8) & 0xFF00) | (lsb)
#define MAKE_WORD32(lsw, msw) (((ATL_Uint32)(msw) << 16) & 0xFFFF0000) | (lsw)
...
typedef struct
{
	ATL_Uint8 u8Full;
	ATL_Uint8 u8Index;
	ATL_Sint8 as8RSSI[NUM_RSSI];
}tstrRSSI;
/* This structure is used to support parsing of the received 'N' message */
typedef struct
{
	ATL_Sint8 s8rssi;
	ATL_Uint16 u16CapInfo;
	ATL_Uint8 au8ssid[MAX_SSID_LEN];
	ATL_Uint8 u8SsidLen;
	ATL_Uint8 au8bssid[6];
	ATL_Uint16 u16BeaconPeriod;
	...
	ATL_Bool bNewNetwork;
#ifdef AGING_ALG
	ATL_Uint8 u8Found;
#endif
#ifdef ATWILC_P2P
	ATL_Uint32 u32Tsf; /* time-stamp [Low only 32 bit] */
#endif
    	ATL_Uint8 *pu8IEs;
	ATL_Uint16 u16IEsLen;
	void* pJoinParams;
	tstrRSSI strRssi;
	ATL_Uint64 u64Tsf; /* time-stamp [Low and High 64 bit] */
}tstrNetworkInfo;

/* This structure is used to support parsing of the received Association Response frame */
typedef struct
{	
	ATL_Uint16 u16capability;
	ATL_Uint16 u16ConnectStatus;
	ATL_Uint16 u16AssocID;
	ATL_Uint8 *pu8RespIEs;
	ATL_Uint16 u16RespIEsLen;
}tstrConnectRespInfo;
...
extern ATL_Sint32 CoreConfiguratorInit(void);
extern ATL_Sint32 CoreConfiguratorDeInit(void);

extern ATL_Sint32 SendConfigPkt(ATL_Uint8 u8Mode, tstrWID* pstrWIDs,
       ATL_Uint32 u32WIDsCount,ATL_Bool bRespRequired,ATL_Uint32 drvHandler);
extern ATL_Sint32 ParseNetworkInfo(ATL_Uint8* pu8MsgBuffer, tstrNetworkInfo** ppstrNetworkInfo);
extern ATL_Sint32 DeallocateNetworkInfo(tstrNetworkInfo* pstrNetworkInfo);

extern ATL_Sint32 ParseAssocRespInfo(ATL_Uint8* pu8Buffer, ATL_Uint32 u32BufferLen, 
									      tstrConnectRespInfo** ppstrConnectRespInfo);
extern ATL_Sint32 DeallocateAssocRespInfo(tstrConnectRespInfo* pstrConnectRespInfo);

#ifndef CONNECT_DIRECT
extern ATL_Sint32 ParseSurveyResults(ATL_Uint8 ppu8RcvdSiteSurveyResults[][MAX_SURVEY_RESULT_FRAG_SIZE],
									 wid_site_survey_reslts_s** ppstrSurveyResults,
									 ATL_Uint32* pu32SurveyResultsCount);
extern ATL_Sint32 DeallocateSurveyResults(wid_site_survey_reslts_s* pstrSurveyResults);
#endif

extern ATL_Sint32 SendRawPacket(ATL_Sint8* pspacket, ATL_Sint32 s32PacketLen);
