/*!  
*  @file	atwilc_wfi_cfg_opertaions.h
...
atwilc_wfi_cfg80211_mgmt_types[NL80211_IFTYPE_MAX] = 
{
...
#define ATWILC_WFI_DWELL_PASSIVE 100
#define ATWILC_WFI_DWELL_ACTIVE  40
...
int ATWILC_WFI_deinit_mon_interface(void);
